...
- `src/App.tsx`
  ...
  - Furniture skin passes currently include bed, desk, dining-table, and fridge skins. Bed skins include Industrial Bed Skin, Wood Red Bed Skin, Ivory Pink Plaid Bed Skin, and Modern Minimal Bed Skin. Desk skins include Industrial Desk Skin and Rococo Ivory Desk Skin. Table skins include Rococo Ivory Table Skin and Dark Oak Table Skin. Fridge skins include Ivory Fridge Skin. Purchased skins can be applied or cleared without entering placement mode and do not affect furniture placement, collision, pathfinding, or interaction targets. Clearing an applied furniture skin removes that furniture id from `activeFurnitureSkinIds` while preserving ownership in `purchasedItemIds`.
...
- `src/game/renderScene.ts`
  ...
  - Renders Checker Tile Floor with black/white tile checks, Polished Cement Floor with fine smooth concrete texture and gloss, Industrial Metal Floor with shaded plates/rivets and a top-to-bottom brightness gradient, Gray Tech Floor with medium-gray octagonal cut-corner tech panels, subtle cyan circuit traces, small violet nodes, and softened bevel edges, and Tatami Mat Floor with green binding and softened woven straw texture.
...
- Furniture Skin shop category:
  - Implemented skins currently cover the base bed, desk, dining table, and fridge. Bed skins: Industrial Bed Skin, Wood Red Bed Skin, Ivory Pink Plaid Bed Skin, and Modern Minimal Bed Skin. Desk skins: Industrial Desk Skin and Rococo Ivory Desk Skin. Table skins: Rococo Ivory Table Skin and Dark Oak Table Skin. Fridge skins: Ivory Fridge Skin.
...
6. Continue expanding and QA'ing the furniture skin system, especially File Cabinet skins and regression coverage for existing bed, desk, table, and fridge skins. Keep skins visual-only unless a future skin explicitly changes dimensions/collision. Add screenshot/runtime QA for Furniture Skins: shop category visibility, purchased/apply/clear states, `activeFurnitureSkinIds` save/load, default furniture fallback, Industrial Bed Skin, Wood Red Bed Skin, Ivory Pink Plaid Bed Skin and sleep blanket overlay, Modern Minimal Bed Skin including bed length, bedding/headboard alignment, thin mattress front edge, tray edge, visible legs, avatar layering, and sleep blanket overlay, default desk and Industrial Desk Skin sleeping-cat black-silhouette/brief-eyes-open animation, Industrial Desk Skin table-leg perspective, Rococo Ivory Desk Skin, Rococo Ivory Table Skin with iris motifs, Dark Oak Table Skin, and Ivory Fridge Skin including open-door animation.
7. Visually QA the recent Ocean Window, Cyberpunk City Window, White Tech Wallpaper, Gray Tech Floor, Growth, Oil Easel, Blue Persian Rug, Sky Sentinel Poster, Exposed Red Brick Wallpaper, bed layering, table collision, and exploration-learning changes in the running app: Ocean Window slow subpixel ship movement, distant ship scale, night ship lights, breathing wave sparkles, softened horizon, Cyberpunk City Window fixed-time preview states, night light density, building structure variation, silver rounded frame, neon billboard animation, cloud looping, seven-lane doubled-speed traffic, smooth non-worming flying-car motion, White Tech Wallpaper panel/circuit readability, Gray Tech Floor octagonal panel readability/softened bevel edges/Decor thumbnail/purchase/apply/clear state, Chinese labels, Coffee Cup slow steam, Growth hex chart hover/log-scale normalization behavior, Oil Easel scale/perspective, avatar beret/brush/palette paint pose, easel foot-collision avoidance, Blue Persian Rug symmetry/detail density/underlay layering/repeatable shop purchase state, Sky Sentinel Poster frame containment/cape direction/robot dog readability/wall placement, red brick wall scale/mortar/baseboard texture, bed body/footboard occlusion, dedicated `admire` pose readability, and idle `explore` route collection.
