...
21. Expand save-state versioning beyond the current layout migration so old `localStorage` layouts can adapt to new furniture dimensions, content tags, memory fields, storage fields, and origin changes more robustly.
