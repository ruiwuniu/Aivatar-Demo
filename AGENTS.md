...
- `src-tauri/tauri.conf.json`
  ...
  - Current desktop release metadata is `0.4.1` across `package.json`, `package-lock.json`, `src-tauri/Cargo.toml`, `src-tauri/Cargo.lock`, and `src-tauri/tauri.conf.json`. Release tag `v0.4.1` publishes the universal macOS DMG `Aivatar_0.4.1_universal.dmg`, Windows NSIS installer `Aivatar_0.4.1_x64-setup.exe`, Windows MSI installer `Aivatar_0.4.1_x64_en-US.msi`, and the Windows checksum manifest generated by `.github/workflows/release-windows.yml`.
